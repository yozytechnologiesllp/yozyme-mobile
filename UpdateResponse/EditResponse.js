...
function EditResponse({ editing, setEditing, EmpId, clientDropdown, setClientDropdown,
    leadDropdown, setLeadDropdown,
    techDetail, setTechDetail,
    client, setClient,
    ...
    roleDetail, setRoleDetail,
    MDAFileAttachment, setMDAFileAttachment,
    AttachmentFileName, setAttachmentFileName,
    setRows, rows, responseId, refreshTable }) {
    ...
    if(client=="") { alert("Please Choose Client") }
      ...
      rows.map((e, i)=>{
        if(e.Site==""){
          ...
          if(rows.length==len ) {
            axios.patch('presales_response?ResponseId=eq.'+responseId,postData)
    .then((res)=>{alert('Proposal Edited Successfully')
...
const countryOptions =  Contries.map((e) => ({
    label: e.name
  }))
  return (
                  ...
                  <Row className="Emp_columnResponse ">
                    ...
                    <Col>
                      ...
                      <Select
                        ...
                        options={techOptions}
                        maxMenuHeight={150}
                        value={techStack.length!=0?techOptions.filter(obj => techStack[0].Technology.includes(obj.label)):[]} 
                        onChange={(e) => {
                          ...
                          <tr key={i}>
                            ...
                            <td>
                              <Select
                                ...
                                value={onShoreOption.filter(x => x.label === rows[i].Site)}                                         
                                required
                              />
                            </td>
                            ...
                            <td>
                              <Select
                                ...
                                required
                                value={countryOptions.filter(x => x.label == rows[i].Country)}
                              />
                            </td>
                            <td>
                              <Select
                                ...
                                value={roleOptions.filter(x => x.label == rows[i].Role)}
                                required
                              />
                            </td>
                            ...
                            <td>
                              <Select
                                ...
                                value={techOptions.filter(x => x.label == rows[i].Skill)}
                                required
                              />
                            </td>
                          </tr>
